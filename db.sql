...
INSERT INTO `proyects` VALUES (1,17,'Fin de curso','2025-02-27 21:37:56'),(2,17,'prueba','2025-02-27 21:37:59'),(3,18,'prueba2','2025-02-27 22:16:20'),(4,18,'prueba3','2025-02-27 22:17:38'),(5,18,'prueba4','2025-02-28 09:03:10'),(6,17,'proyecto modificado 3 - 2','2025-02-28 09:04:11'),(7,6,'proyecto modificado 3 aaa','2025-02-28 17:03:13');
...
INSERT INTO `proyects_members` VALUES (1,6,1,16),(1,8,1,150),(1,15,1,5),(1,16,1,5),(2,16,0,1),(2,17,1,1),(3,17,1,1),(7,6,0,5);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Historial en el cual se guardará los usuarios que entran, salen y hacen cualquier cosa como por ejemplo terminar una tarea';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `proyects_members_history` VALUES (1,6,'add',7,'2025-03-01 10:16:22'),(2,17,'add',1,'2025-03-03 15:26:47');
...
INSERT INTO `proyects_tasks_history` VALUES (1,10,1,'2025-03-01 12:56:58'),(2,10,2,'2025-03-01 12:57:16'),(3,11,1,'2025-03-01 15:39:21'),(4,12,1,'2025-03-01 15:40:51'),(5,13,1,'2025-03-01 16:56:58'),(6,14,1,'2025-03-01 17:04:36'),(7,15,1,'2025-03-01 17:06:19'),(8,14,2,'2025-03-01 17:26:22'),(11,18,1,'2025-03-06 17:41:54');
...
INSERT INTO `proyects_tasks_users` VALUES (8,18,1),(15,1,1),(15,2,1),(15,18,1),(16,2,1),(16,11,1),(18,10,1);
...
BEGIN
    ...
    users.registred AS user_registred,
    users.id AS user_id
    FROM proyects_members INNER JOIN users ON proyects_members.user_id = users.id AND proyects_members.proyect_id = proyectId;
...
-- Dump completed on 2025-03-07  0:23:53
