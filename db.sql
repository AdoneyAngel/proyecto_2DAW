...
CREATE TABLE `proyects_members` (
  ...
  CONSTRAINT `fr_proyectsMembers_proyectsMembersTypes` FOREIGN KEY (`type_id`) REFERENCES `proyects_members_types` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `proyects_members` VALUES (1,6,0,1,3),(1,8,1,1505,3),(1,10,1,5,1),(1,11,0,1,2),(1,12,0,1,2),(1,15,1,5,2),(1,16,1,5,2),(1,18,1,1,1),(2,16,0,1,2),(2,17,1,1,2),(3,17,1,1,2),(7,6,0,5,2);
...
INSERT INTO `proyects_members_history` VALUES (1,6,'add',7,'2025-03-01 10:16:22'),(2,17,'remove',1,'2025-03-03 15:26:47'),(3,10,'add',1,'2025-03-10 21:39:55'),(4,11,'add',1,'2025-03-12 22:15:33'),(5,12,'add',1,'2025-03-12 22:21:21'),(6,6,'add',1,'2025-03-15 12:16:38'),(7,6,'remove',1,'2025-03-15 12:24:41'),(8,11,'remove',1,'2025-04-09 19:20:34'),(9,6,'add',1,'2025-04-09 19:21:01'),(10,18,'add',1,'2025-04-09 19:26:13');
/*!40000 ALTER TABLE `proyects_members_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `proyects_members_types`
--

DROP TABLE IF EXISTS `proyects_members_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `proyects_members_types` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `proyects_members_types`
--

LOCK TABLES `proyects_members_types` WRITE;
/*!40000 ALTER TABLE `proyects_members_types` DISABLE KEYS */;
INSERT INTO `proyects_members_types` VALUES (1,'admin'),(2,'member'),(3,'viewer');
/*!40000 ALTER TABLE `proyects_members_types` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `proyects_tasks_users` VALUES (6,21,1),(8,14,1),(8,26,1),(10,19,1),(15,1,1),(15,11,1),(15,26,1),(16,9,1),(16,11,1),(16,19,1),(18,10,1),(10,1,2),(15,14,2),(17,9,2),(15,18,3);
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proyects_members_insert`(IN proyectId INT, IN userId INT, IN effective_timeVar INT, IN typeIdVar INT)
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proyects_members_update`(IN userId INT, IN proyectId INT, IN statusVar INT, IN effectiveTime INT, IN typeIdVar INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `proyects_tasks_history_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proyects_tasks_history_id`(IN taskId INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `proyects_tasks_update_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proyects_tasks_update_status`(IN taskId INT, IN newStatus INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `users_insert_with_google` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `users_insert_with_google`(IN usernameVar VARCHAR(255), IN emailVar VARCHAR(255), IN googleIdVar VARCHAR(255), IN photoVar VARCHAR(255))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `user_add_password` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `user_add_password`(IN userId INT, IN passwordVar VARCHAR(255))
BEGIN
...
-- Dump completed on 2025-04-13 19:43:03
